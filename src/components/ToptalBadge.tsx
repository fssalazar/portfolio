...
const TOPTAL_URL =
  "https://www.toptal.com/developers/resume/felipe-salazar#NVxLRZ";
...
export function ToptalBadge() {
  return (
    <motion.a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="View Felipe Salazar's Toptal profile — Top 3% Talent"
      className={styles.r}
    ...
    >
      <div className={styles.h}>
        <div className={styles.a}>
          ...
          <span className={styles.f}>Hire me</span>
        </div>
      </div>
    </motion.a>
  );
